...
echo "Building Arca BuildKit Image..."

# Configuration
SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_ROOT="$(dirname "$SCRIPT_DIR")"
BUILDKIT_DIR="$PROJECT_ROOT/buildkit-image"
OUTPUT_DIR="$HOME/.arca/buildkit"
IMAGE_NAME="arca/buildkit"
IMAGE_TAG="latest"
...
echo "Step 1: Building BuildKit image with vsock proxy..."
cd "$BUILDKIT_DIR"
...
# Step 2: Save as OCI Image Layout
echo "Step 2: Saving image as OCI Image Layout..."
...
echo ""
echo "✓ BuildKit OCI image built successfully"
